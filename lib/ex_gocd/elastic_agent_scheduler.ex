defmodule ExGoCD.ElasticAgentScheduler do
  ...
  def tracked_pods do
    ExGoCD.DistSingleton.call(__MODULE__, :tracked_pods)
  end

  @doc "Return recent scheduler events (for admin UI)."
  def recent_events do
    ExGoCD.DistSingleton.call(__MODULE__, :recent_events)
  end

  @doc "Delete all tracked k8s pods and return count."
  def delete_all_pods do
    ExGoCD.DistSingleton.call(__MODULE__, :delete_all_pods)
  end
