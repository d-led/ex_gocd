  ...
  def call(conn, _opts) do
    case conn.path_info do
      ["pipelines", "value_stream_map", pipeline_name, pipeline_counter] ->
        maybe_rewrite(conn, ["api_json", "pipelines", "value_stream_map", pipeline_name, pipeline_counter], pipeline_counter)

      ["go", "pipelines", "value_stream_map", pipeline_name, pipeline_counter] ->
        maybe_rewrite(conn, ["api_json", "go", "pipelines", "value_stream_map", pipeline_name, pipeline_counter], pipeline_counter)

      ["materials", "value_stream_map", material_fingerprint, revision] ->
        maybe_rewrite(conn, ["api_json", "materials", "value_stream_map", material_fingerprint, revision], revision)

      ["go", "materials", "value_stream_map", material_fingerprint, revision] ->
        maybe_rewrite(conn, ["api_json", "go", "materials", "value_stream_map", material_fingerprint, revision], revision)
